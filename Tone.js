! function (t, e) {
    ...
    return function (t) {
                ...
                for (let h = 0; h < a; h += 128) {
                    if (n.numberOfInputs > 0 && null !== e)
                        for (let t = 0; t < n.numberOfInputs; t += 1)
                            for (let s = 0; s < n.channelCount; s += 1) gt(e, d[t], s, s, h);
        ...
        const en = ((t, e, s, n, i, o) => class extends t {
            ...
            dn = cn ? ((t, e, s, n, i, o, r, a, c, h, u, l) => (p, d, f = {
                ...
                if (void 0 !== m.audioWorklet) return Promise.all([i(d), Promise.resolve(t(u, u))]).then(([t, e]) => {
                    const [s, n] = y(t, g), i = e ? n : n.replace(/\s+extends\s+AudioWorkletProcessor\s*{/, " extends (class extends AudioWorkletProcessor {__b=new WeakSet();constructor(){super();(p=>p.postMessage=(q=>(m,t)=>q.call(p,m,t?t.filter(u=>!this.__b.has(u)):t))(p.postMessage))(this.port)}}){"), o = new Blob([`${s};(registerProcessor=>{${i}\n})((n,p)=>registerProcessor(n,class extends p{${e ? "" : "__c = (a) => a.forEach(e=>this.__b.add(e.buffer));"}process(i,o,p){${e ? "" : "i.forEach(this.__c);o.forEach(this.__c);this.__c(Object.values(p));"}return super.process(i.map(j=>j.some(k=>k.length===0)?[]:j),o,p)}}))`], {
        ...
        const kn = (t => (e, s, n = 0, i = 0) => {
                    ...
                    if (null !== B)
                        for (let s = 0; s < A; s += 128) {
                            for (let e = 0; e < g.numberOfInputs; e += 1)
                                for (let n = 0; n < g.channelCount; n += 1) gt(t, W[e], n, n, s);
                ...
                return {
                    render(w, b, S) {
                        ...
                        return void 0 !== k ? Promise.resolve(k) : (async (a, w, b) => {
                            ...
                            if (C)
                                for (const [e, s] of a.parameters.entries()) await t(w, s, S.parameters.get(e), b);
                            else
                                for (const [t, e] of a.parameters.entries()) await d(w, e, S.parameters.get(t), b);
            ...
            })(Tn, We, cs, Rn, En, N, qn, Me, qe, pn, t => ({
                ...t,
        ...
        function wi(t, ...e) {
            ...
            const s = e.shift();
            if (oi(t) && oi(s))
                for (const e in s) xi(e, s[e]) ? t[e] = s[e] : oi(s[e]) ? (t[e] || Object.assign(t, {
                    [e]: {}
        ...
        function bi(t, e, s = [], n) {
            ...
            if (1 === o.length && oi(o[0])) wi(i, o[0]);
                ...
                for (let t = 0; t < s.length; t++) si(o[t]) && (i[s[t]] = o[t]);
            return wi(t, i)
        }
        ...
        class Vi extends ki {
            ...
            off(t, e) {
                return t.split(/\W+/).forEach(s => {
                    if (ei(this._events) && (this._events = {}), this._events.hasOwnProperty(t))
